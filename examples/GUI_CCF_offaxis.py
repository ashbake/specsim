...
###keep^
           ...
           #  calc noise
            ...
            ccf_cal = 0.01
            host_flux_at_obj = self.obs_s *self.obs_speckle_noise
            systematics = (ccf_cal*(host_flux_at_obj+self.obs_thermal))**2
            noise_plus_systematics = np.sqrt(self.obs_noise**2+systematics)
            ...
            self.obs_ccf_snr = ccf_snr
            #self.obs_snr = self.obs_s/self.obs_noise
            print((self.obs_ccf_snr))
            print(np.min(self.obs_ccf_snr))
            print(np.max(self.obs_ccf_snr))
            print(np.mean(self.obs_ccf_snr))
